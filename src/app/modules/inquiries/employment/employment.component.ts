...
export class EmploymentComponent implements OnInit {
  ...
  search() {
    if (this.appointmentNumber) {
      // Navigate to the user/employment/:number route
      this.router.navigate(['/crafted/pages/inquiries/employment', this.appointmentNumber])
      .then(() => {
  ...
  updateData() {
    if (confirm('Are you sure you want to enroll this user?')) {
      ...
      // Cancel employment
      console.log('Employment cancelled.');
    }
  }
